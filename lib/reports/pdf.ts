...
function loadEmbeddedFonts(): FontDictionary {
  // pdfmake ships Roboto fonts within its virtual file system bundle.
  // We decode the base64 entries into Buffers so PdfPrinter can consume them.
...
const printer = new PdfPrinter(loadEmbeddedFonts());
